...
private const val GithubLatestReleaseUrl =
    "https://api.github.com/repos/cursoralex20-hue/TradeDavd/releases/latest"
private const val GithubLatestNightlyRunUrl =
    "https://api.github.com/repos/cursoralex20-hue/TradeDavd/actions/workflows/build-nightly-apk.yml/runs?branch=main&status=success&per_page=1"
private const val NightlyArtifactDownloadUrl =
    "https://nightly.link/cursoralex20-hue/TradeDavd/workflows/build-nightly-apk.yml/main/Aether-nightly.zip"
